                  ...
                  child: Container(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          ...
                          style: TextStyles.subhead(context).copyWith(fontWeight: FontWeight.w500, color: Colors.white, fontSize: 19),
                        ),
                      ),
                  ),
                  onTap: (){
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Container(
                      ...
                      child: Visibility(
                        visible: Provider.of<BibleModel>(context, listen: false).selectedChapter > 1,
                        child: Material(
                          child: InkWell(
                            onTap: () {
                              if (Provider.of<BibleModel>(context, listen: false).selectedChapter > 1) {
                                int currentitm = Provider.of<BibleModel>(context, listen: false).selectedChapter - 2;
