...
class _VideoPlayerState extends State<VideoPlayer>
  ...
  Future<ChewieController?> playVideoStream() async {
    videoPlayerController =
        vd.VideoPlayerController.network(currentMedia!.streamUrl!);
    await videoPlayerController.initialize();
    chewieController = ChewieController(
        videoPlayerController: videoPlayerController,
        autoPlay:
            Provider.of<AppStateManager>(context, listen: false).autoPlayVideos,
          ...
          children: [
            SafeArea(
              child: Column(
                children: <Widget>[
                  Container(
                      height: 270, child: buildVideoContainer(currentMedia!)),
                  (playlist.length == 0)
                      ? Expanded(
                          child: Column(
                            children: <Widget>[
