...
class LikesPostPeople extends StatefulWidget {
  static const routeName = "/likesPostPeople";
  LikesPostPeople({this.userPost});
  final UserPosts? userPost;

  @override
  LikesPostPeopleRouteState createState() => new LikesPostPeopleRouteState();
}

class LikesPostPeopleRouteState extends State<LikesPostPeople> {
  List<Userdata>? items = [];
  ...
  Future<void> fetchItems() async {
    ...
    try {
      ...
      final response = await dio.post(
        ApiUrl.postLikesPeople,
        data: jsonEncode({
          "data": {
            "post": widget.userPost!.id,
