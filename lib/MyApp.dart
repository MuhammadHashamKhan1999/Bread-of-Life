...
import 'package:churchapp_flutter/screens/NewNoteScreen.dart';
...
import './screens/NoteEditorScreen.dart';
      ...
      child: MaterialApp(
        ...
        onGenerateRoute: (settings) {
          ...
          if (settings.name == AddPlaylistScreen.routeName) {
            ...
            final ScreenArguements? args = settings.arguments as ScreenArguements?;
            return MaterialPageRoute(
              builder: (context) {
          ...
          if (settings.name == LivestreamsPlayer.routeName) {
            ...
            return MaterialPageRoute(
              builder: (context) {
                return LivestreamsPlayer(liveStreams: args!.items as LiveStreams?);
              },
            );
          }
          ...
          if (settings.name == AnnouncementsScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
          ...
          if (settings.name == CommentsScreen.routeName) {
            // Cast the arguments to the correct type: ScreenArguments.
            final CommentsArguement? args = settings.arguments as CommentsArguement?;
            return MaterialPageRoute(
              builder: (context) {
          ...
          if (settings.name == Downloader.routeName) {
            ...
            return MaterialPageRoute(
              builder: (context) {
                return Downloader(downloads: args!.items as Downloads?, platform: platform);
              },
            );
          }
          ...
          if (settings.name == LeadersScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
          ...
          if (settings.name == GalleryAlbumsScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
                return GalleryAlbumsScreen();
              },
            );
          }
        ...
        if (settings.name == DocumentFoldersScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
                return DocumentFoldersScreen();
              },
            );
          }

        if (settings.name == MinistriesScreen.routeName) {
            return MaterialPageRoute(
              builder: (context) {
