...
class SingleMinistryInfoScreen extends StatefulWidget {
  SingleMinistryInfoScreen({Key? key, this.item}) : super(key: key);
  static const routeName = "/singleMinistryInfoScreen";
  Result? item;

  @override
  _SingleMinistryInfoScreenState createState() => _SingleMinistryInfoScreenState();
}

class _SingleMinistryInfoScreenState extends State<SingleMinistryInfoScreen> {
