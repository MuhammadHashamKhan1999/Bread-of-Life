import 'package:churchapp_flutter/screens/NoteEditorScreen.dart';
                ...
                InkWell(
                  ...
                  onTap: () async {
                    ...
                    await FlutterShare.share(
                        title: object.title!,
                        text: quill.Document.fromJson(jsonDecode(object.content!))
                            .toPlainText());
                  },
                ),
                Container(width: 15),
                InkWell(
                  ...
                  onTap: () {
                    FlutterClipboard.copy(
                        quill.Document.fromJson(jsonDecode(object.content!))
                            .toPlainText())
