              ...
              if (bibleModel.isBibleHighlighted(widget.object)) {
                ...
                if (bible != null) {
                  ...
                  return Column(
                    ...
                    children: [
                      Center(child: Text(bibleModel.selectedVersion!, style: TextStyle(color: Colors.redAccent, fontWeight: FontWeight.w500),)),
                      SizedBox(height: 4,),
                      RichText( // SIGBLO
                        text: TextSpan(
                          style: TextStyles.subhead(context).copyWith(fontWeight: FontWeight.w500),
                          children: <TextSpan>[
                            TextSpan(
                              text: widget.object.verse.toString() + ".",
                              style: TextStyle(fontSize: fontSize.toDouble()),
